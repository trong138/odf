...
class PauseAction{
    ...
    do(resolve, reject){
        co((function* () {
            ...
            yield this.redmine_utils.trackIssueLog(issue_id, `Paused #${issue_id}. Temp save time for this issue`, false);
            // var issue_link = `${this.auth.redmine_host}/issues/${issue_id}`;
            // yield this.chat_utils.log("User pause issue", `Pause #${issue_id}: ${issue_info.issue.subject}`, `User @${this.auth.redmine_user_login}.\nReason ${reason_input}`, issue_link);
